            ...
            >
                {({ y }) =>
                        <div className={styles.flipContainer}>
                            ...
                            >
                                <div onMouseEnter={
                                    () => this.setState({rotate: rotate + 20})
                                }
                                onMouseLeave={
                                    () => this.setState({rotate: rotate - 20})
                                }
                                ...
                                <div className={styles.btnProfile} onClick={() => this.setState({rotate: rotate + 180 })}>
                                    <FaPencil/>
                                </div>
                            </div>
                            <div className={styles.edit}>
                                <div className={styles.btnEdit} onClick={() => this.setState({rotate: rotate + 180 })}>
                                    <FaRotateLeft/>
                                </div>
                            </div>
                        </div>
