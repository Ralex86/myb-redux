        ...
        return(
            <div>
                ...
                {position.length > 0 &&
                    <Map 
                        containerElement={
                          <div style={{position: 'fixed', zIndex: 2, height: '23em', width: '100%' }} />
                        }
                        mapElement={
                            <div style={{height: '23em', width: '100%' }} />
                        }
                ...
                {isAssetsEmpty ?
                    ...
                    <div>
                        ...
                        <div className={styles.wrapper} style={main ? {marginLeft: 0} : {marginLeft: '-100%'}}>
